...
const EditContent = ({ closeEditModal, game }) => {
  ...
  useEffect(() => {
    if (game) {
      ...
      setYear(game.year);
      setPlatform(game.price);
    }
  }, [game]); // A dependêndia é o que faz o useEffect ser executado novamente

  // Função para enviar o formulário e realizar as alterações na API
